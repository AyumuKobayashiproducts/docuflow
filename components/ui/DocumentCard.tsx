  ...
  return (
    ...
    >
      ...
      <div className="mb-3 pr-20">
        <Link
          href={`/documents/${id}${locale === "en" ? "?lang=en" : ""}`}
      ...
      {tags && tags.length > 0 && (
        <div className="mb-4 flex flex-wrap gap-1.5">
          {tags.slice(0, 4).map((tag) => (
            <Link
              key={tag}
              href={`/app?q=${encodeURIComponent(tag)}${locale === "en" ? "&lang=en" : ""}`}
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
            <Button
              ...
              aria-label={isPinned ? (locale === "en" ? "Unpin" : "ピン解除") : (locale === "en" ? "Pin" : "ピン留め")}
            >
            ...
            <Button
              ...
              aria-label={isFavorite ? (locale === "en" ? "Remove favorite" : "お気に入り解除") : (locale === "en" ? "Add favorite" : "お気に入り追加")}
            >
                ...
                <>
                  ...
                  <div className="absolute right-0 bottom-full mb-1 z-50 w-40 rounded-lg border border-slate-200 bg-white py-1 shadow-lg dark:border-slate-700 dark:bg-slate-800">
                    ...
                    >
                      ...
                      {isArchived ? (locale === "en" ? "Restore" : "復元") : (locale === "en" ? "Archive" : "アーカイブ")}
                    </button>
                    <button

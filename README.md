...
- [`docs/demo-script-interview.md`](docs/demo-script-interview.md)
...
**プロジェクト全体のAI呼び出し回数に上限**を掛けられます（超えたらAIだけ停止、アプリは動く）。
...
AI操作（例: 要約再生成）に **簡易レート制限**を入れているので、短時間の連打で料金が膨らみにくいです。
